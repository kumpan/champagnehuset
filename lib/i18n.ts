...
const sv = {
  ...
  filterVintage: "Årgångschampagne",
  filterYear: "Årgång",
  filterVolume: "Volym",
...
const byLanguage: Record<string, Dict> = {
  ...
  en: {
    ...
    filterVintage: "Vintage Champagne",
    filterYear: "Vintage",
    filterVolume: "Volume",
  ...
  de: {
    ...
    filterClub: "Special Club",
    filterEcologic: "Bio",
    filterVintage: "Jahrgangschampagner",
    filterYear: "Jahrgang",
  ...
  fr: {
    ...
    filterVintage: "Champagne millésimé",
  ...
  it: {
    ...
    filterVintage: "Champagne millesimato",
    filterYear: "Annata",
    filterVolume: "Volume",
  ...
  es: {
    ...
    filterVintage: "Champán de añada",
    filterYear: "Añada",
    filterVolume: "Volumen",
  ...
  pt: {
    ...
    filterVintage: "Champanhe de colheita",
    filterYear: "Colheita",
    filterVolume: "Volume",
  ...
  da: {
    ...
    filterVintage: "Årgangschampagne",
    filterYear: "Årgang",
    filterVolume: "Volumen",
    availabilityPrivateImport: "Privatimport",
    availabilityRestaurant: "Restaurant",
  ...
  nn: {
    ...
    filterVintage: "Vuosikertasamppanja",
  ...
  pl: {
    ...
    filterVintage: "Szampan rocznikowy",
    filterYear: "Rocznik",
