      ...
      >
        ...
        <div
          className={cn(
            ...
            containerThemeClasses[section_theme || "Ocean"],
          )}
        >
          {breadcrumbs && breadcrumbs.length > 1 && (
            <BreadcrumbNav items={breadcrumbs} className="mb-1.5 -ml-2" sectionTheme={section_theme || "Ocean"} />
          )}
          <SectionIntro
            overline={overline}
          ...
          {details && details.length > 0 && (
            <InfoItems
              className="mt-4"
              theme={section_theme || "Ocean"}
              itemClassName={infoItemsThemeClasses[section_theme || "Ocean"]}
