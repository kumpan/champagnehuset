...
export type ImageGridProps = ImageProps & { slice: Content.ImageSliceGrid };

const getMediaKey = (item: Content.ImageSliceGridPrimaryMediaItem, index: number) => {
...
export function ImageGrid({ slice }: ImageGridProps) {
