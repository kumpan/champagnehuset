    ...
    >
      <Container className="flex flex-col gap-6 md:gap-8 lg:gap-12">
        ...
        <div className="flex flex-col 3xl:gap-20 gap-6 md:gap-8 lg:flex-row lg:gap-8 xl:gap-12 2xl:gap-16">
          <CustomRichText sectionTheme={section_theme || "Ocean"} field={first_text_block} className="w-full" />
          <CustomRichText sectionTheme={section_theme || "Ocean"} field={second_text_block} className="w-full" />
        </div>
      </Container>
    </Section>
  );
