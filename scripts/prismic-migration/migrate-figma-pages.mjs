...
if (!writeToken) {
  console.error(
    "Missing PRISMIC_WRITE_TOKEN — run with: node --env-file=.env.local scripts/prismic-migration/migrate-figma-pages.mjs --uid <uid>",
  );
  process.exit(1);
}
...
const PAGES = {
  "om-oss": {
    ...
    meta_description:
      "Vi tror på odlarchampagne. Sedan starten har vårt mål varit att lyfta fram människorna, platserna och berättelserna bakom några av Champagnes mest spännande odlare.",
    slices: [
      // 1 · HeroBackdrop
      {
        slice_type: "hero",
        ...
        primary: {
          ...
          description: rt(
            p(
              "Sedan starten har vårt mål varit enkelt – att lyfta fram människorna, platserna och berättelserna bakom några av Champagnes mest spännande odlare.",
            ),
          ),
          buttons: [],
          media: [{ image: img("omoss-hero", WIDE, "Vingård i Champagne") }],
        },
        items: [],
      },
      // 2 · TextSplit
      {
        ...
        primary: {
          ...
          first_text_block: rt(
            p(
              "ChampagneHuset grundades 2002 ur en enkel övertygelse: att några av de mest intressanta champagnerna inte kommer från de största husen, utan från människorna som lever sina liv bland vingårdarna. Sedan starten har vi rest genom Champagne för att lära känna odlarna bakom flaskorna – människor som känner varje parcell och låter platsen forma vinernas karaktär.",
            ),
          ),
          second_text_block: rt(
            p(
              "Idag representerar vi 16 familjeägda odlare som delar samma syn på hantverk, kvalitet och ursprung. De arbetar på olika sätt och i olika delar av regionen, men förenas av en ambition: att skapa viner som speglar platsen de kommer ifrån. För oss handlar champagne om mer än vad som finns i glaset – om människorna, kunskapen som gått i arv och stunderna då ett glas för människor samman.",
            ),
          ),
        },
        items: [],
      ...
      // 3 · TextMedia
      {
        ...
        primary: {
          ...
          text_side: false,
          first_text_block: rt(
            h("Odlare med egna uttryck och tydlig karaktär", "heading3"),
            p(
          ...
          second_text_block: rt(
            h("Ett sortiment som speglar Champagne i all sin mångfald", "heading3"),
            p(
              "Resultatet är ett sortiment som speglar hela regionen – från de kritrika sluttningarna i Côte des Blancs till de böljande landskapen i Côte des Bar. Från eleganta Blanc de Blancs till kraftfulla årgångschampagner med lång lagringspotential. ChampagneHuset är vår samlade kärlek till Champagne, och en inbjudan att upptäcka människorna, platserna och berättelserna bakom varje flaska.",
            ),
          ),
      ...
      // 7 · CalloutContact
      {
        ...
        primary: {
          ...
          description: rt(
            ...
            p(
              "Med en passion för odlarchampagne arbetar hon för att lyfta fram de små husens hantverk och berättelser, från vingårdarna till glaset hemma hos dig.",
            ),
          ),
          buttons: [],
          ...
          contact_items: [
            ...
            {
              icon: "mail",
              label: "Skicka ett mejl",
              value: "ida.timen@twscollective.se",
              link: "mailto:ida.timen@twscollective.se",
            },
          ],
        },
        items: [],
  ...
  "special-club": {
    ...
    meta_description:
      "Special Club är berättelsen om några av Champagnes mest ambitiösa odlare och deras gemensamma vilja att visa vad småskaligt hantverk kan åstadkomma.",
    slices: [
      // 1 · HeroStack
      {
        slice_type: "hero",
        ...
        primary: {
          ...
          description: rt(
            p(
              "Special Club är berättelsen om några av Champagnes mest ambitiösa odlare – och deras gemensamma vilja att visa vad småskaligt hantverk kan åstadkomma. Upptäck viner där kompromisslös kvalitet och kärleken till den egna vingården alltid talar högst.",
            ),
          ),
          buttons: [],
          media: [{ filter: "Bottom Left", image: img("sc-hero", WIDE, "Special Club") }],
        },
        items: [],
      },
      // 2 · TextSplit
      ...
      // 4 · ValueText
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Endast de viner som klarar de hårda kraven får bära den karakteristiska flaskan. Här är de sex grundreglerna varje odlare måste följa:",
            ),
          ),
          buttons: [],
          statement: [
            {
              title: "1. Föreningsmedlem",
              description:
                "Champagnen måste vara producerad av en aktiv medlem i föreningen Club Trésors de Champagne.",
            },
            {
              title: "2. Egna vingårdar",
              description:
                "Ett absolut krav på ursprung: Druvorna måste komma uteslutande från producentens egna vingårdar.",
            },
            {
              title: "3. Alltid årgång",
              description:
                "Champagnen är alltid årgångsbetecknad för att spegla just det årets specifika och unika växtförhållanden.",
            },
            {
              title: "4. Lång lagring",
              description: "Vinet måste genomgå en lång tids lagring i källaren innan det är redo för lansering.",
            },
            {
              title: "5. Dubbel granskning",
              description:
                "Varje vin godkänns av en oberoende panel vid två tillfällen: före den andra jäsningen, och igen efter flera års lagring.",
            },
            {
              title: "6. Det absolut bästa",
              description:
                "En Special Club-flaska är inte vilken champagne som helst. Den måste representera producentens absolut främsta vin.",
            },
          ],
        },
        items: [],
      ...
      // 6 · CalloutSplit (image left)
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Vi reser ständigt till Champagne för att bygga nära relationer med odlarna och hitta de där unika flaskorna som de stora husen sällan visar. För oss handlar varje glas om ett genuint hantverk, en specifik plats och människorna som viger sina liv åt att förfina det.",
            ),
          ),
          buttons: [
            {
              link: link("/om-oss", "Läs mer om oss"),
              variant: "default",
              icon_left: "none",
              icon_right: "arrowUpRight",
            },
      ...
      // 7 · CalloutSplit (image right, Brand)
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Idag representerar vi majoriteten av medlemmarna i Club Trésors de Champagne i Sverige och arbetar dagligen för att göra deras champagner tillgängliga för svenska champagneälskare.",
            ),
            p(
              "Genom dessa engagerade odlare får vi möjlighet att utforska hela Champagne. Från de kritrika sluttningarna i Côte des Blancs till de kalk- och lerjordar som präglar Côte des Bar. Deras främsta årgångschampagner skapas för att spegla platsen, året och människorna bakom vinet.",
            ),
          ),
          buttons: [
            {
              link: link("/odlare", "Läs mer om producenterna"),
              variant: "default",
              icon_left: "none",
              icon_right: "arrowUpRight",
            },
    ...
    slices: [
      ...
      // 3 · ContactForm (NOTE: Figma intro + value statements are generic placeholder copy)
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Hör av er idag för en förutsättningslös dialog om hur vi kan stärka era kundrelationer och effektivisera era processer.",
            ),
          ),
          value_statements: [
        ...
        items: [
          {
            field_type: "name",
            field_label: "Förnamn",
            field_placeholder: "Anna",
            field_required: true,
            new_row: true,
          },
          {
            field_type: "name",
            field_label: "Efternamn",
            field_placeholder: "Andersson",
            field_required: true,
            new_row: false,
          },
          {
            field_type: "email",
            field_label: "E-postadress",
            field_placeholder: "anna@foretag.se",
            field_required: true,
            new_row: true,
          },
          {
            ...
            field_placeholder: "Exempel AB",
            field_required: false,
            new_row: false,
          },
          {
            field_type: "textarea",
            field_label: "Meddelande",
            field_placeholder: "Hej! Jag vill veta mer om era tjänster...",
            field_required: true,
            new_row: true,
          },
        ],
      ...
      // 5 · ContactRegister (newsletter)
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Prenumerera på vårt nyhetsbrev och få nyheter från våra odlarhus, exklusiva släpp, provningstips och inbjudningar till våra evenemang – direkt i din inkorg",
            ),
          ),
          email_label: "E-postadress",
          email_placeholder: "anna@foretag.se",
      ...
      // 6 · FAQSplit (NOTE: Figma questions/answers are placeholder gibberish)
      {
        ...
        primary: {
          ...
          description: rt(
            p(
              "Champagne kan väcka många frågor – från druvor och årgångar till leveranser och provningar. Här har vi samlat svaren på de vanligaste.",
            ),
          ),
          faqlist: [
            {
              question: "Godis wireframe köttbullar-driven design väntan boll påtår?",
              answer: rt(
                p(
                  "Mysig öl pinne väntan julöl snabb björn rebase, frågvis. Skumöl hund köttbulle, designsystem lagård lazy-loadad ljus stånka lättöl lagom tomte, deploya. Skog kanel ljus tomte sommar vatten lagom stout. Knäckebröd skägg jäst mysig härlig, moln fatöl roadmap förstås, tomte.",
                ),
              ),
            },
  ...
  faq: {
    ...
    meta_description:
      "Svar på de vanligaste frågorna om champagne och odlarchampagne – från druvor, dosage och årgångar till beställning, servering och förvaring.",
    slices: [
      // 1 · HeroStack
      {
        slice_type: "hero",
      ...
      // 2 · FAQList — Om champagne
      {
        ...
        primary: {
          ...
          description: rt(
            p("Det som är bra att veta om druvorna, stilarna och begreppen bakom flaskorna vi arbetar med."),
          ),
          faqlist: [
            {
              question: "Vad är odlarchampagne?",
              answer: rt(
                p(
                  "Odlarchampagne (récoltant-manipulant) är champagne som odlaren gör på druvor från sina egna vingårdar, hela vägen från skörd till buteljering. Till skillnad från de stora husen, som köper in druvor från många leverantörer, speglar odlarchampagne en enskild familjs marker och stil – ofta med tydligare ursprung och mer personlig karaktär.",
                ),
              ),
            },
            {
              question: "Vad betyder Blanc de Blancs och Blanc de Noirs?",
              answer: rt(
                p(
                  "Blanc de Blancs görs enbart på gröna druvor, i praktiken nästan alltid Chardonnay, och är ofta elegant, citrusfrisk och mineralisk. Blanc de Noirs görs enbart på blå druvor (Pinot Noir och/eller Pinot Meunier) och blir vanligtvis fylligare och mer fruktdriven.",
                ),
              ),
            },
            {
              question: "Vad är Special Club?",
              answer: rt(
                p(
                  "Special Club (Club Trésors de Champagne) är en sammanslutning av kvalitetsinriktade odlare. En Special Club-champagne är alltid ett årgångsvin som måste godkännas av en oberoende panel i två steg och representera producentens allra bästa vin. Den känns igen på sin egen, karakteristiska flaskform.",
                ),
              ),
            },
            {
              question: "Vad innebär dosage och Brut Nature?",
              answer: rt(
                p(
                  "Dosage är den lilla mängd socker som tillsätts efter degorgeringen och avgör hur torr champagnen upplevs. Brut Nature (0–3 g/l) är i princip helt utan tillsatt socker, Extra Brut är mycket torr och Brut (upp till 12 g/l) är den vanligaste, torra stilen.",
                ),
              ),
            },
            {
              question: "Vad är skillnaden mellan Grand Cru och Premier Cru?",
              answer: rt(
                p(
                  "Det är en klassificering av byarna i Champagne. Druvor från de sjutton Grand Cru-byarna anses ha högst potential, följt av Premier Cru. Beteckningen säger något om ursprunget – men inte allt om kvaliteten. Odlarens arbete i vingård och källare är minst lika avgörande.",
                ),
              ),
            },
            {
              question: "Vad betyder årgång (millésime)?",
              answer: rt(
                p(
                  "En årgångschampagne är gjord på druvor från ett enda år och buteljeras bara när skörden anses tillräckligt bra. Den speglar just det årets karaktär, medan en icke-årgångschampagne (NV) blandar flera år för en jämn och igenkännbar husstil.",
                ),
              ),
            },
          ],
      ...
      // 3 · FAQList — Beställning & leverans
      {
        ...
        primary: {
          ...
          faqlist: [
            {
              question: "Hur beställer jag champagne?",
              answer: rt(
                p(
                  "Våra viner säljs via Systembolaget – i butik, som beställningsvara eller i webbshoppen. På varje produktsida hittar du artikelnummer och en länk vidare. Vissa viner finns även som privatimport för restaurang och företag.",
                ),
              ),
            },
            {
              question: "Vad är skillnaden mellan ordinarie sortiment och beställningssortiment?",
              answer: rt(
                p(
                  "Ordinarie sortiment står i butikshyllan, medan beställningssortimentet tas hem på beställning och levereras till din valda butik, oftast inom några dagar. Många av våra mer exklusiva odlarchampagner finns i beställningssortimentet.",
                ),
              ),
            },
            {
              question: "Kan företag och restauranger köpa direkt?",
              answer: rt(
                p(
                  "Ja. För restaurang, hotell och företag erbjuder vi privatimport av flera viner som inte finns på Systembolaget. Hör av dig till oss så hjälper vi dig vidare med urval och beställning.",
                ),
              ),
            },
            {
              ...
              answer: rt(
                p(
                  "Vid beställning via Systembolaget är leveranstiden vanligtvis 2–7 arbetsdagar till vald butik. Under högsäsong som jul och nyår kan det ta något längre tid.",
                ),
              ),
            },
            {
              question: "Hjälper ni till med större beställningar och gåvor?",
              answer: rt(
                p(
                  "Gärna. För bröllop, event och företagsgåvor ger vi råd kring urval och volym. Kontakta oss så återkommer vi med förslag anpassade efter tillfället.",
                ),
              ),
            },
          ],
      ...
      // 4 · FAQList — Servering & förvaring
      {
        ...
        primary: {
          ...
          faqlist: [
            {
              question: "Vilken temperatur ska champagne serveras i?",
              answer: rt(
                p(
                  "Servera champagne svalt, runt 8–10 °C. Mogna årgångschampagner och fylligare Blanc de Noirs mår bra av någon grad varmare, kring 10–12 °C, vilket lyfter fram aromerna. Undvik iskallt – då stänger sig doften.",
                ),
              ),
            },
            {
              question: "Vilket glas är bäst?",
              answer: rt(
                p(
                  "Ett tulpanformat vitvinsglas är att föredra framför den smala flöjten. Den större kupan ger doften plats att utvecklas samtidigt som formen bevarar bubblorna. Den breda coupe-skålen är vacker men släpper ut mousse och arom för snabbt.",
                ),
              ),
            },
            {
              question: "Hur länge kan jag spara champagne?",
              answer: rt(
                p(
                  "Icke-årgångschampagne dricks med fördel inom några år från köp. Årgångsviner och Special Club kan ofta utvecklas fint i tio år eller mer vid rätt förvaring. Våra viner är redan lagrade och redo att avnjutas vid lansering.",
                ),
              ),
            },
            {
              question: "Hur förvarar jag champagne hemma?",
              answer: rt(
                p(
                  "Förvara flaskorna liggande, mörkt och svalt (10–14 °C) med jämn temperatur, borta från ljus och vibrationer. Ett kylskåp fungerar för kortare tid, men för längre lagring är en sval källare eller vinkyl bäst.",
                ),
              ),
            },
            {
              question: "Hur öppnar jag flaskan säkert?",
              answer: rt(
                p(
                  "Håll ett fast grepp om korken, luta flaskan lätt och vrid på flaskan – inte korken. Låt korken glida ut med ett diskret väsande snarare än en smäll, så bevarar du moussen och undviker spill.",
                ),
              ),
            },
            {
              question: "Anordnar ni provningar?",
              answer: rt(
                p(
                  "Ja, vi håller regelbundet provningar och event – från nybörjarvänliga introduktioner till fördjupande vertikalprovningar. Håll utkik i Journalen och i vårt nyhetsbrev för kommande tillfällen.",
                ),
              ),
            },
          ],
...
for (const uid of uids) {
  const def = PAGES[uid];
  if (!def) {
    console.error(`No definition for "${uid}"`);
    continue;
  }
